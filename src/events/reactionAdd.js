...
import { handleReactionXP } from '../handlers/levelingHandler.js';
...
export default {
    ...
    async execute(reaction, user, client) {
        ...
        await reactionRoleHandler.handleReaction(reaction, user, config, false);
        await handleReactionXP(reaction, user, config);
    }
};
